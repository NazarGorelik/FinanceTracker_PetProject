...
public class AccountController {
    ...
    @PostMapping("/save")
    public HttpStatus createAccount(@RequestBody @Valid AccountDTO accountDTO, BindingResult bindingResult,
    ...
    public String updateAccount(@AuthenticationPrincipal UserPrincipal userPrincipal,
